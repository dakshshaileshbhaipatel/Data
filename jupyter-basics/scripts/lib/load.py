...
from ..db_operations import connect_db, create_database, drop_database
from .tsv import select_tsv_files, get_columns, table_exists, create_table_sql

def load_tsv_to_postgres():

    try:
        db_result = connect_db()
        if db_result is None:
            raise Exception("Database connection failed: connect_db() returned None")
